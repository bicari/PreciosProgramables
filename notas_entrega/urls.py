...
from .views import render_notas_entrega, search_product_by_code, delete_product, search_product_by_description, modal_search, search_order, search_proveedor, procesar_recepcion, obtener_confirmacion
urlpatterns = [
